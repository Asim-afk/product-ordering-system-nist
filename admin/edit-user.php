            ...
            <form method="post" action="">
                <table class="table">
                    <tr>
                        ...
                        <td><input type="text" name="user_name" value="<?php echo $user_name; ?>" placeholder="Enter your new username.." id="user_name" class="form-control"></td>
                    </tr>
                    <tr>
                        <td class="text-right">
                            FullName
                        </td>
                        <td><input type="text" name="full_name" value="<?php echo $full_name; ?>" placeholder="Enter your new full name.." id="full_name" class="form-control"></td>
                    </tr>
